...
namespace hgcaldigi {
  ...
  inline bool hasCBHeaderError(uint16_t fedUnpackingFlag)  { return ((fedUnpackingFlag>>FEDUnpackingFlags::ErrorCaptureBlockHeader) & 0x1); }
  inline bool hasCBActiveFlags(uint16_t fedUnpackingFlag) { return ((fedUnpackingFlag>>FEDUnpackingFlags::ActiveCaptureBlockFlags) & 0x1); }
  inline bool hasErrorECONDHeader(uint16_t fedUnpackingFlag) { return ((fedUnpackingFlag>>FEDUnpackingFlags::ErrorECONDHeader) & 0x1); }
  inline bool hasECONDPayloadLengthOverflow(uint16_t fedUnpackingFlag) { return ((fedUnpackingFlag>>FEDUnpackingFlags::ECONDPayloadLengthOverflow) & 0x1); }
  inline bool hasECONDPayloadLengthMismatch(uint16_t fedUnpackingFlag) { return ((fedUnpackingFlag>>FEDUnpackingFlags::ECONDPayloadLengthMismatch) & 0x1); }
  inline bool hasErrorSLinkTrailer(uint16_t fedUnpackingFlag) { return ((fedUnpackingFlag>>FEDUnpackingFlags::ErrorSLinkTrailer) & 0x1); }
  inline bool hasEarlySLinkEnd(uint16_t fedUnpackingFlag) { return ((fedUnpackingFlag>>FEDUnpackingFlags::EarlySLinkEnd) & 0x1); }
