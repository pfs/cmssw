...
\newpage %-------------------------------------------------------------------------------------------
\ctitle{Distributions}{Angles between particles in transverse plane}

\centerline{\fig[16cm]{fig/anglesT.pdf}}


\newpage %-------------------------------------------------------------------------------------------
\ctitle{Resolution}{Histograms}

\> resolution: only due to statistical fluctuations in proton reconstruction
\>> perfect reconstruction of Z assumed
\>> no systematics considered

\centerline{\fig[16cm]{fig/resolution_histograms.pdf}}

\>> single-RP: limited by neglected terms in proton propagation (beam div.)
\>> multi-RP: limited by sensor resolution

\newpage %-------------------------------------------------------------------------------------------
\ctitle{Resolution}{Profiles}

\> as previous slide, but resolution plotted as a function of kinematics

\centerline{\fig[16cm]{fig/resolution_profiles.pdf}}
