...
\> example config: SimCTPPS/Generators/test/test\_gen\_simu\_smear\_cfg.py
\>> 2017 layout of RPs (strips in 210-fr, pixels in 220-fr)
\>> preliminary 2017 geometry (RP position), yet to be tuned
\>> aperture limitations simulated with a simple high-$x$ cutoff, preliminary tuning
...
\centerline{\fig[16cm]{fig/hit_distribution.pdf}}
