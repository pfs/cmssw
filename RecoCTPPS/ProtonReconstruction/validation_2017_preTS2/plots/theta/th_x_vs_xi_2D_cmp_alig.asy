...
real c_xi0s[], c_as[];
cols.push("arm0"); c_labels.push("sector 45 (L)"); c_xi0s.push(0.14); c_as.push(-210);
cols.push("arm1"); c_labels.push("sector 56 (R)"); c_xi0s.push(0.175); c_as.push(-290);

string dataset = "fill_6031/xangle_140";
