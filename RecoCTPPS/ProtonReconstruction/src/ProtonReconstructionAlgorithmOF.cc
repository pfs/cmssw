...
ProtonReconstructionAlgorithmOF::ProtonReconstructionAlgorithmOF(const std::string &optics_file_beam1, const std::string &optics_file_beam2,
  ...
  chiSquareCalculator_(std::make_unique<ChiSquareCalculator>(beamConditions_))
{
  ...
  for (const auto &it : idNameMap)
  {
    ...
    string fn_in = (rpId.arm() == 1) ? optics_file_beam1 : optics_file_beam2;
    rpod.optics = make_shared<LHCOpticsApproximatorOF>(fn_in, ofName.c_str());
...
ProtonReconstructionAlgorithmOF::~ProtonReconstructionAlgorithmOF()
{
}

//----------------------------------------------------------------------------------------------------

double ProtonReconstructionAlgorithmOF::ChiSquareCalculator::operator() (const double* parameters) const
{
...
void ProtonReconstructionAlgorithmOF::reconstructFromMultiRP(const vector<const CTPPSLocalTrackLite*> &tracks, vector<reco::ProtonTrack> &out) const
{
  ...
  if (verbosity)
  {
    ...
    printf("* ProtonReconstructionAlgorithmOF::reconstructFromMultiRP(%u)\n", armId);
  ...
  if (verbosity)
    edm::LogInfo("ProtonReconstructionAlgorithmOF")
...
void ProtonReconstructionAlgorithmOF::reconstructFromSingleRP(const vector<const CTPPSLocalTrackLite*> &tracks,
