...
def TICL_iterations_withReco(process,outputCommands):
  outputCommands.extend(['keep *_TrackstersToMultiCluster*_*_*'])
  ...
  process.FilteredLayerClustersMIP.max_cluster_size = 5 # inclusive
...
def TICL_iterations(process,outputCommands):
  outputCommands.extend(['keep *_TrackstersToMultiCluster*_*_*'])
