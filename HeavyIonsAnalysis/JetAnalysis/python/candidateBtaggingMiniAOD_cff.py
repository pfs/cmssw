...
pfDeepFlavourTagInfosSlimmedDeepFlavour = pfDeepFlavourTagInfos.clone(
    ...
    unsubJets = cms.InputTag("ak4PFMatchingForakCs0PFpatJets"),
...
candidateBtagging = cms.Sequence(
    ...
    #pfParticleNetFromMiniAODAK4CHSCentralTagInfosSlimmedDeepFlavour +
    #pfParticleNetFromMiniAODAK4CHSForwardTagInfosSlimmedDeepFlavour + 
    pfParticleTransformerAK4TagInfosSlimmedDeepFlavour + 
    pfJetProbabilityBJetTags +
    pfDeepCSVJetTags +
    pfDeepFlavourJetTagsSlimmedDeepFlavour +
    #pfParticleNetFromMiniAODAK4CHSCentralJetTagsSlimmedDeepFlavour +
    #pfParticleNetFromMiniAODAK4CHSForwardJetTagsSlimmedDeepFlavour +
    #pfParticleNetFromMiniAODAK4CHSCentralDiscriminatorsJetTagsSlimmedDeepFlavour +
    #pfParticleNetFromMiniAODAK4CHSForwardDiscriminatorsJetTagsSlimmedDeepFlavour +
