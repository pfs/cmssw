...
quantities.push("xi"); q_labels.push("\xi"); q_units.push(""); q_scales.push(1.); q_mean_lims.push(0.004); q_RMS_lims.push(0.008);
quantities.push("th_x"); q_labels.push("\th^*_x"); q_units.push("\ung{\mu rad}"); q_scales.push(1e6); q_mean_lims.push(20.); q_RMS_lims.push(40.);
quantities.push("th_y"); q_labels.push("\th^*_y"); q_units.push("\ung{\mu rad}"); q_scales.push(1e6); q_mean_lims.push(20.); q_RMS_lims.push(40.);
